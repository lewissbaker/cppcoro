	...
	std::experimental::coroutine_handle<> awaiter)
{
	...
	m_ioState.m_callback = &file_read_operation::on_operation_completed;
...
{
	auto* operation = reinterpret_cast<file_read_operation*>(
		reinterpret_cast<char*>(ioState) -
		offsetof(file_read_operation, m_ioState));
