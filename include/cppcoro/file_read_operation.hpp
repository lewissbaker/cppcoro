...
namespace cppcoro
{
	...
	class file_read_operation
		: public cppcoro::detail::io_operation<file_read_operation>
	{
	public:
		...
		file_read_operation(
			...
			void* buffer,
			std::size_t byteCount) noexcept
			: cppcoro::detail::io_operation<file_read_operation>(fileOffset)
			, m_impl(fileHandle, buffer, byteCount)
		{}

	private:

		friend class cppcoro::detail::io_operation<file_read_operation>;
	...
	private:
		...
		friend class cppcoro::detail::io_operation_cancellable<file_read_operation_cancellable>;
...
namespace cppcoro
{
    ...
    class file_read_operation
        : public cppcoro::detail::uring_operation<file_read_operation>
    {
    public:
        ...
        file_read_operation(
            ...
            void* buffer,
            std::size_t byteCount) noexcept
            : cppcoro::detail::uring_operation<file_read_operation>(ioService, fileOffset)
            , m_impl(fileHandle, buffer, byteCount)
        {}

    private:

        friend class cppcoro::detail::uring_operation<file_read_operation>;
    ...
    class file_read_operation_cancellable
        : public cppcoro::detail::uring_operation_cancellable<file_read_operation_cancellable>
    {
    public:
        ...
        file_read_operation_cancellable(
            ...
            std::size_t byteCount,
            cancellation_token&& cancellationToken) noexcept
            : cppcoro::detail::uring_operation_cancellable<file_read_operation_cancellable>(
    ...
    private:
        ...
        friend class cppcoro::detail::uring_operation_cancellable<file_read_operation_cancellable>;
