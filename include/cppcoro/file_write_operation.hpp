...
namespace cppcoro
{
	...
	public:
		file_write_operation_impl(
			detail::handle_t fileHandle, const void* buffer, std::size_t byteCount) noexcept
	...
	class file_write_operation : public cppcoro::detail::io_operation<file_write_operation>
	{
	public:
