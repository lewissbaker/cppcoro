...
namespace cppcoro
{
	...
	private:
		...
		stdcoro::coroutine_handle exchange_next(
			stdcoro::coroutine_handle<> coroutine) noexcept
		{
		...
		size_t m_index;
		const stdcoro::coroutine_handle<> m_noop;
		std::array<stdcoro::coroutine_handle<>, N - 1> m_coroutines;
	};
#endif
}
