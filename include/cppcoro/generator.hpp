...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		public:
			...
			constexpr stdcoro::suspend_always initial_suspend() const { return {}; }
			constexpr stdcoro::suspend_always final_suspend() const { return {}; }

			template<
				typename U = T,
				std::enable_if_t<!std::is_rvalue_reference<U>::value, int> = 0>
			stdcoro::suspend_always yield_value(std::remove_reference_t<T>& value) noexcept
			{
