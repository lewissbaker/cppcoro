...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		private:
			...
			stdcoro::coroutine_handle<> m_consumerCoroutine;
		...
		public:
			...
			async_generator_yield_operation(stdcoro::coroutine_handle<> consumer) noexcept
				: m_consumer(consumer)
			{}
			...
			await_suspend([[maybe_unused]] stdcoro::coroutine_handle<> producer) noexcept
			{
				return m_consumer;
			}
		...
		private:
			...
			stdcoro::coroutine_handle<> m_consumer;
		...
		protected:
			...
			async_generator_advance_operation(
				...
				stdcoro::coroutine_handle<> producerCoroutine) noexcept
		...
		public:
			...
			stdcoro::coroutine_handle<>
				await_suspend(stdcoro::coroutine_handle<> consumerCoroutine) noexcept
			{
		...
		protected:
			...
			stdcoro::coroutine_handle<> m_producerCoroutine;
	...
	public:
		...
		explicit async_generator(promise_type& promise) noexcept
			: m_coroutine(stdcoro::coroutine_handle<promise_type>::from_promise(promise))
		{}
	...
	namespace detail
	{
		...
		public:
			...
			bool await_suspend(stdcoro::coroutine_handle<> producer) noexcept;
		...
		inline bool async_generator_yield_operation::await_suspend(
			stdcoro::coroutine_handle<> producer) noexcept
		{
		...
		public:
			...
			bool await_suspend(stdcoro::coroutine_handle<> consumerCoroutine) noexcept
			{
				m_promise->m_consumerCoroutine = consumerCoroutine;
